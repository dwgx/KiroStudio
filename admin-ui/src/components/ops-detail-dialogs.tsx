...
const OUTCOME_META: Record<string, { labelKey: string; variant: BadgeProps['variant'] }> = {
  ...
  empty_response: { labelKey: 'opsdetaildialogs.outcome.emptyResponse', variant: 'destructive' },
  interrupted: { labelKey: 'opsdetaildialogs.outcome.interrupted', variant: 'warning' },
}
